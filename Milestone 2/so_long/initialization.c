...
/*   Updated: 2024/09/30 14:22:52 by kagoh            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_assets(t_game *game)
{
	...
	if (!game->p_img || !game->wall_img || !game->c_img || !game->floor_img
		|| !game->exit_img)
	{
		if (game->p_img)
